inherited FrmTiposDocumentos: TFrmTiposDocumentos
  Caption = 'FrmTiposDocumentos'
  ClientHeight = 496
  OnCreate = FormCreate
  ExplicitHeight = 535
  PixelsPerInch = 96
  TextHeight = 13
  object bsPC: TbsSkinPageControl [0]
    Left = 0
    Top = 0
    Width = 728
    Height = 496
    ...
    SkinDataName = 'tab'
    object tsListagem: TbsSkinTabSheet
      Caption = 'Listagem'
    ...
    object tsDados: TbsSkinTabSheet
  ...
  inherited cdsBase: TClientDataSet
    Left = 608
    Top = 65520
    object cdsBaseID: TIntegerField
      AutoGenerateValue = arAutoInc
      DisplayLabel = 'C'#243'digo'
      FieldName = 'ID'
    end
    object cdsBaseDESCRICAO: TStringField
